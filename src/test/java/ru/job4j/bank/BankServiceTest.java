...
public class BankServiceTest {
    ...
    public void addExistingAccount() {
        ...
        bank.addUser(user);
        bank.addAccount(user.getPassport(), new Account("5546", 150D));
        bank.addAccount(user.getPassport(), new Account("5546", 1D));
        assertThat(bank.findByRequisite("3434", "5546").get().getBalance(), is(150D));
    }
    ...
    @Test
    public void when150minus50Then0() {
        User user = new User("3434", "Petr Arsentev");
        BankService bank = new BankService();
        bank.addUser(user);
        bank.addAccount(user.getPassport(), new Account("5546", 150D));
    ...
    @Test
    public void whenNotFindRequisiteThenNull() {
        User user = new User("3434", "Petr Arsentev");
        BankService bank = new BankService();
        bank.addUser(user);
        bank.addAccount(user.getPassport(), new Account("5546", 150D));
        assertThat(bank.findByRequisite("3434", "5544"), is(Optional.empty()));
    }
}